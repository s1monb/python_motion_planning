...
def plot_goals(goals, planners, plt, title, colors=None):
    ...
    for goal in goals:
        for planner in planners:
            ...
            time_data[planner].append(execution_time*1000)
            path_data[planner].append(path)
            scatter_data[planner].append((execution_time*1000, cost_value))
    ...
    for planner in planners:
        if planner in time_data and time_data[planner]:
            ...
            if planner == "a_star_3d":
                labels.append("A*")
            elif planner == "gbfs_3d":
                labels.append("GBFS")
            elif planner == "jps_3d":
                labels.append("JPS")
            elif planner == "dijkstra_3d":
                labels.append("Dijkstra")
            else:
    ...
    #         if planner == "a_star_3d":
    #             cost_labels.append("A*")
    #         elif planner == "gbfs_3d":
    #             cost_labels.append("GBFS")
    #         elif planner == "jps_3d":
    #             cost_labels.append("JPS")
    #         elif planner == "dijkstra_3d":
    #             cost_labels.append("Dijkstra")
    #         else:
    ...
    # # Customize colors for cost box plot - use same color mapping as time box plot
    # for i, patch in enumerate(cost_box_plot['boxes']):
    #     patch.set_facecolor(colors[i % len(colors)])
    ...
    for i, planner in enumerate(planners):
        if planner in scatter_data and scatter_data[planner]:
            ...
            plt.scatter(times, costs, c=colors[i % len(colors)], 
                       label=label, 
                       alpha=0.7, s=50)
    
    plt.xlabel("Execution Time (miliseconds)", fontsize=12)
    plt.ylabel("Cost (path length)", fontsize=12)
...
if __name__ == '__main__':
    ...
    multi_floor_goals = floor_2_goals | floor_3_goals | floor_4_goals | floor_5_goals
    ...
    # med dijkstra
    plot_goals(floor_1_goals, planners, plt, "Start Floor 1 → Goal Floor 1", ['blue', 'green', 'red', 'orange'])
    # plot_goals(floor_2_goals, planners, plt, "Start Floor 1 → Goal Floor 2", ['blue', 'green', 'red', 'orange'])
    # plot_goals(floor_3_goals, planners, plt, "Start Floor 1 → Goal Floor 3", ['blue', 'green', 'red', 'orange'])
    # plot_goals(floor_4_goals, planners, plt, "Start Floor 1 → Goal Floor 4", ['blue', 'green', 'red', 'orange'])
    # plot_goals(floor_5_goals, planners, plt, "Start Floor 1 → Goal Floor 5", ['blue', 'green', 'red', 'orange'])
    # multi floor
    # plot_goals(multi_floor_goals, planners, plt, "Start Floor 1 → Goal Floor 2-5", ['blue', 'green', 'red', 'orange'])
    
    # uten dijkstra
    planners = ["a_star_3d", "gbfs_3d", "jps_3d"]
    # plot_goals(floor_1_goals, planners, plt, "Start Floor 1 → Goal Floor 1", ['blue', 'red', 'orange'])
    # plot_goals(floor_2_goals, planners, plt, "Start Floor 1 → Goal Floor 2", ['blue', 'red', 'orange'])
    # plot_goals(floor_3_goals, planners, plt, "Start Floor 1 → Goal Floor 3", ['blue', 'red', 'orange'])
    # plot_goals(floor_4_goals, planners, plt, "Start Floor 1 → Goal Floor 4", ['blue', 'red', 'orange'])
    # plot_goals(floor_5_goals, planners, plt, "Start Floor 1 → Goal Floor 5", ['blue', 'red', 'orange'])
    # multi floor
    # plot_goals(multi_floor_goals, planners, plt, "Start Floor 1 → Goal Floor 2-5", ['blue', 'red', 'orange'])
